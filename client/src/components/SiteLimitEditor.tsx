 ...
 */
export default function SiteLimitEditor({ groups = allGroups.filter(group => group !== "Modals" && group !== "Input Field Text" && group !== "Button Section" && group !== "Platform charge") }: { groups?: SiteLimitGroup[] } = {}) {
