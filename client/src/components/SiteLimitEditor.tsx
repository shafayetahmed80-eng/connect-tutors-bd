...
const allGroups: SiteLimitGroup[] = ["Selection", "Job board", "Uploads", "Text length", "Modals", "Input Field Text"];
 ...
 */
export default function SiteLimitEditor({ groups = allGroups.filter(group => group !== "Modals" && group !== "Input Field Text") }: { groups?: SiteLimitGroup[] } = {}) {
