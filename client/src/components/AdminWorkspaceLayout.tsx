...
import { BarChart3, ClipboardList, ContactRound, FileUser, Globe, House, LayoutDashboard, LayoutTemplate, ListChecks, Loader2, PanelsTopLeft, ShieldCheck, UserRoundCog, UsersRound } from "lucide-react";
