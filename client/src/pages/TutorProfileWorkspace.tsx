...
function TutorProfileWorkspaceBody({
   ...
   * keeps its exact current copy. No label says "(Optional)" - an optional field stays optional without the word.
   */
  ...
  const renderField = (fieldId: string): React.ReactNode => {
    switch (fieldId) {
      ...
      case "privateDetails.motherName": return <FormInput label={fieldLabel(fieldId, "Mother’s Name")} placeholder="Ex- Abdul Karim" value={form.privateDetails.motherName} onChange={event => updatePrivateDetail("motherName", event.target.value)} />;
      case "privateDetails.motherPhone": return <FormPhoneInput label={fieldLabel(fieldId, "Mother’s Phone Number")} value={form.privateDetails.motherPhone} onChange={value => updatePrivateDetail("motherPhone", value)} error={phoneErrors.motherPhone} />;
      case "privateDetails.emergencyContactName": return <FormInput label={fieldLabel(fieldId, "Emergency Contact Name")} placeholder="Ex- Rahima Begum" value={form.privateDetails.emergencyContactName} onChange={event => updatePrivateDetail("emergencyContactName", event.target.value)} />;
      case "privateDetails.emergencyContactRelation": return <FormInput label={fieldLabel(fieldId, "Emergency Contact Relation")} placeholder="Ex- Uncle" value={form.privateDetails.emergencyContactRelation} onChange={event => updatePrivateDetail("emergencyContactRelation", event.target.value)} />;
      case "privateDetails.emergencyContactPhone": return <FormPhoneInput label={fieldLabel(fieldId, "Emergency Contact Phone")} value={form.privateDetails.emergencyContactPhone} onChange={value => updatePrivateDetail("emergencyContactPhone", value)} error={phoneErrors.emergencyContactPhone} />;
      ...
      case "resultGpa": return <FormInput label={fieldLabel(fieldId, `${tutorProfileCopy.fields.resultGpa}`)} value={form.resultGpa} onChange={event => update("resultGpa", event.target.value)} placeholder="Ex-4.00" />;
      case "deptId": return <FormInput label={fieldLabel(fieldId, `${tutorProfileCopy.fields.deptId}`)} value={form.deptId} onChange={event => update("deptId", event.target.value)} placeholder="Ex-13104096" />;
      ...
      case "primarySubjectIds": return <SearchableMultiSelect className={wideFieldClassName} label={fieldLabel(fieldId, tutorProfileCopy.fields.primarySubjects)} required options={toSelectorOptions(subjects.data)} selectedIds={form.primarySubjectIds} onChange={value => update("primarySubjectIds", value)} emptyMessage="No subjects found." error={fieldErrors.primarySubjectIds} maxSelections={Math.max(1, limits["tutor.subjects"] - form.additionalSubjectIds.length)} />;
      case "additionalSubjectIds": return <SearchableMultiSelect className={wideFieldClassName} label={fieldLabel(fieldId, tutorProfileCopy.fields.additionalSubjects)} options={toSelectorOptions(subjects.data)} selectedIds={form.additionalSubjectIds} onChange={value => update("additionalSubjectIds", value)} emptyMessage="No subjects found." maxSelections={Math.max(0, limits["tutor.subjects"] - form.primarySubjectIds.length)} />;
      case "classLevelIds": return <SearchableMultiSelect className={wideFieldClassName} label={fieldLabel(fieldId, tutorProfileCopy.fields.classLevels)} required options={groupedClassLevels.options} selectedIds={groupedClassLevels.selectedIds} onChange={value => update("classLevelIds", expandGroupedClassLevelIds(value, groupedClassLevels.groupedIds))} emptyMessage="No classes or levels found." error={fieldErrors.classLevelIds} maxSelections={limits["tutor.levels"]} />;
      case "curriculumIds": return <SearchableMultiSelect className={wideFieldClassName} label={fieldLabel(fieldId, tutorProfileCopy.fields.curricula)} required options={toSelectorOptions(curricula.data)} selectedIds={form.curriculumIds} onChange={value => update("curriculumIds", value)} emptyMessage="No curricula found." error={fieldErrors.curriculumIds} />;
      ...
      case "tuitionType": return <SearchableMultiSelect className={wideFieldClassName} label={fieldLabel(fieldId, tutorProfileCopy.fields.tuitionType)} required options={[{ id: "home", label: "Home tuition" }, { id: "online", label: "Online tuition" }, { id: "group", label: "Group tuition" }, { id: "package", label: "Package tuition" }]} selectedIds={form.tuitionTypes} onChange={value => update("tuitionTypes", value)} emptyMessage="No tuition types found." error={fieldErrors.tuitionTypes} />;
      ...
      case "teachingAreaIds": return <SearchableMultiSelect className={wideFieldClassName} label={fieldLabel(fieldId, tutorProfileCopy.fields.teachingAreas)} required options={teachingAreaOptions} selectedIds={form.teachingAreaIds} onChange={value => update("teachingAreaIds", value)} onSearchQueryChange={setTeachingAreaQuery} emptyMessage="No areas found." error={fieldErrors.teachingAreaIds} />;
  ...
  const renderEducationRecordField = (fieldId: string, record: TeachingProfileState["educationRecords"][number], index: number): React.ReactNode => {
    ...
    switch (fieldId) {
      ...
      case "educationRecords.resultGpa": return <FormInput label={fieldLabel(fieldId, `${tutorProfileCopy.fields.resultGpa}`)} value={record.resultGpa} onChange={event => updateEducationRecord(index, "resultGpa", event.target.value)} placeholder="Ex-5.00" />;
      ...
      case "educationRecords.registrationNumber": return <FormInput label={fieldLabel(fieldId, "Registration Number")} placeholder="Ex- 1234567890" value={record.registrationNumber} onChange={event => updateEducationRecord(index, "registrationNumber", event.target.value)} />;
      default: return null;
    }
  };
