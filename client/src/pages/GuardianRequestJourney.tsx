...
function Eyebrow({ step, title, copy }: { step: string; title: string; copy: string }) { return <div className="border-b border-[#e6eef4] pb-5"><p className="text-xs font-extrabold uppercase tracking-[.16em] text-j-accent">{step}</p><h2 className="mt-2 text-2xl font-extrabold tracking-[-.03em] text-j-ink">{title}</h2><p className="mt-2 text-sm leading-6 text-[#617e96]">{copy}</p></div>; }
