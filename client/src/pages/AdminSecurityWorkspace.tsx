...
import { AlertTriangle, CircleUserRound, ClipboardCopy, Eye, EyeOff, KeyRound, ShieldCheck, UserMinus, Users } from "lucide-react";
...
function SecurityWorkspaceContent() {
  ...
  if (loading || workspaceAccess.isLoading) return <div className="flex min-h-[60vh] items-center justify-center text-j-ink-soft"><LoadingCradle className="mr-2" /> Checking Owner permissions…</div>;
