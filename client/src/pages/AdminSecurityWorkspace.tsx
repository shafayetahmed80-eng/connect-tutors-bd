...
function SecurityWorkspaceContent() {
  ...
  return <div className="mx-auto max-w-7xl space-y-5 pb-10">
    <section className="rounded-3xl bg-[#0f4666] p-6 text-white shadow-[0_18px_42px_rgba(15,70,102,0.16)] sm:p-8"><div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between"><div><p className="text-xs font-bold uppercase tracking-[0.18em] text-cyan-200">Owner-only controls</p><h1 className="mt-2 text-3xl font-bold tracking-tight">Admin access management</h1><p className="mt-2 max-w-3xl text-sm leading-6 text-sky-100">Create time-limited Admin invitations, assign dedicated User IDs and passwords, and review privacy-minimized access events. Share credential details only through a verified private channel.</p></div><ShieldCheck className="h-11 w-11 text-cyan-200" /></div></section>
