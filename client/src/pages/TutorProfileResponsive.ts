...
export const tutorProfileResponsiveClasses = {
  workspace: "w-full min-w-0 overflow-x-clip space-y-6",
  ...
  completionCard: "rounded-2xl border border-[#b7ddeb] bg-white/95 p-4 shadow-[0_12px_26px_rgba(38,83,117,0.14)] backdrop-blur lg:sticky lg:top-3 lg:z-20",
