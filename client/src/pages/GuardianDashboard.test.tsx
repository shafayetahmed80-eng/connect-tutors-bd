...
describe("Guardian Dashboard navigation", () => {
  it("keeps operational Guardian destinations separate from planned placeholders", () => {
    ...
    expect(active.map(item => item.label)).toEqual(["Dashboard", "Hire a tutor", "Profile", "Attendance", "Posted jobs", "Applied Tutors", "Notifications", "Confirmation Letter", "Settings", "How it works", "Sign Out"]);
