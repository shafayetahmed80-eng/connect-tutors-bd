...
const signInSlots: SiteContentSlot[] = [
  ...
  { id: "sign-in.newHere", page: "info-pages", surface: "Sign in", group: "Register links", label: "Lead-in", defaultText: "New here?", defaultTextClass: "text-sm", kind: "text-only" },
  { id: "sign-in.registerGuardian", page: "info-pages", surface: "Sign in", group: "Register links", label: "Guardian link", defaultText: "Register as Guardian", defaultTextClass: "text-sm", kind: "text-only" },
  { id: "sign-in.registerTutor", page: "info-pages", surface: "Sign in", group: "Register links", label: "Tutor link", defaultText: "Register as Tutor", defaultTextClass: "text-sm", kind: "text-only" },
