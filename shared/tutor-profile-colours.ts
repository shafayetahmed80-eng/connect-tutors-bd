...
export const tutorProfileColours: Record<TutorProfileColourPart, { cssVar: string; defaultHex: string; label: string; help: string }> = {
  ...
  label: { cssVar: "--tp-label", defaultHex: "#6b8497", label: "Label colour", help: "Field names beside their answers, hints and captions. Placeholders use a paler shade of it." },
