...
- উপরে ডানে: **+ Post another request** → জার্নিটা খালি ধাপ ১-এ ফেরে। শিটের ভিতরে ফর্ম আর
  নিশ্চিতকরণ একই ঠিকানায় বসে, তাই লিংক দিয়ে নতুন ফর্মে যাওয়ার উপায় নেই — উত্তরগুলো মুছে দেয়
- নিচে মাঝখানে: **View my request** → Posted jobs ট্যাব

সারিগুলো ধাপ ৩-এর রিভিউয়ের সাথে হুবহু এক — দুই পর্দা একই `buildGuardianRequestSummary()`
